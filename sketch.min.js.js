const setPallete_HEX = document.querySelector('#pe3')
const setPallete_HEX_border = document.querySelector('#pe3')
const fill_check = document.querySelector('#fill_check')
/**
...
Object.assign(Colorpalette.prototype, {
    ...
    setColor: function setColor(col, noPropagate) {
        ...
        var rgba = this.getColor();
        // this.colorEl.style.backgroundColor = "rgba(" + rgba.red + "," + rgba.green + "," + rgba.blue + "," + rgba.alpha + ")";
        this.colorEl.style.backgroundColor = "rgba(" + 0 + "," + 0 + "," + 0 + "," + 1 + ")";
...
console.log('rgba?',hexToRgbA(setPallete_HEX.value))
ToolCirc.prototype = Object.create(ToolFillable.prototype);

setPallete_HEX.addEventListener('click', (e)=>{
    ...
    toolId: "circle",
    keyCode: 67, //c
    color:  hexToRgbA(setPallete_HEX.value),

    fillColor:  hexToRgbA(setPallete_HEX_border.value),
    /**
...
setPallete_HEX.addEventListener('input', (e) => {
   for(let i = 0; i < 3; i++){
    ...
    Object.assign(ToolCirc.prototype, {
        ...
        fillColor: hexToRgbA(setPallete_HEX.value),
...
Object.assign(ToolType.prototype, {
    ...
    startInput: function startPath(id, x, y, e) {
        ...
        let flMenu = document.body.querySelector('div[data-v-ebbacb64=""]')
        let fontStyle = document.body.querySelector('select[data-v-28064cda=""]').value
        let fontSz = document.body.querySelector('select[data-v-d6eb0194').value
        let removeInput = document.body.querySelector('button[data-v-ebbacb64')
        let colPal = document.body.querySelector('#inputPalette')
        ...
        var inputWidth = this.sketchpad.width/12 + 100;
        
        fontLoad.style.display = 'block'
        input.typeInput = document.createElement("input");
        let menuIsOpen = true
        input.typeInput.value = "Text";
        input.typeInput.placeholder = "Text";
        ...
        input.typeInput.style.fontSize = fontSz/1.2 + "px";
        input.typeInput.style.display = "inline-block";
        input.typeInput.style.color = colPal.value;
        ...
        if (this.sketchpad.centerViewport) {
            ...
            // fontLoad.style.left = this.sketchpad.width / 2.7 + x - 1 + "px";
            // fontLoad.style.top =  this.sketchpad.height / 1.6 + y - this.getSize() / 2 + "px";
            // fontLoad.style.display = 'block'
        } else {
        ...
        input.typeInput.style.height = fontSz + "px";
        ...
        function write() {
            ...
            if (input.typeInput.written && menuIsOpen) {
                return false;
            }
            ...
            flMenu.addEventListener('click', (e)=>{
                menuIsOpen = true
           })
        }
...
Object.assign(Sketchpad.prototype, {
    ...
    showGrid: function drawGrid(config) {
        ...
        if(gridType.value === 'Dot'){
             ...
             clearGrid()
            drawDot()
        }else if(gridType.value === 'Line'){
            clearGrid()
            console.log(gridType.value)
            drawLine()
        }else if(gridType.value === 'Pure'){
             clearGrid()
        }
        ...
        function drawDots() {
         ...
         function drawLine(){
            ...
            function lineV(x, color) {
                line(0, - that.height / 2, 0, that.height / 2, color);
            }
            ...
            //     lineV(-x, "rgba(255,0,0," + subAlpha + ")");
            // }
            for (y = 0; y <= that.height / 1; y += 35) {
                
                
              lineH(y, "rgba(0,0,0," + alpha + ")");
            }
            for (y = 35; y <= that.height / 1; y += 35) {
                lineH(-y, "rgba(0,0,0," + alpha + ")");
            }
         ...
         function clearGrid(){
            function line(x1, y1, x2, y2, color) {
                ...
                context.moveTo(x1, y1);
                context.clearRect(x1, y1, canvas.width, canvas.height);
                context.stroke();
            }
            function lineH(y, color) {
                line(-that.width / 2, y, that.width / 2, y, color);

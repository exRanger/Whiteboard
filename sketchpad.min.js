...
Object.assign(ToolType.prototype, {
    ...
    startInput: function startPath(id, x, y, e) {
        ...
        input.typeInput.style.position = "relative";
        ...
        if (this.sketchpad.centerViewport) {
            ...
            // input.typeInput.style.left = this.sketchpad.width / 2.7 + x - 1 + "px";
            // input.typeInput.style.top = this.sketchpad.height / 2.3 + y - this.getSize() / 2 + "px";

            

            // input.typeInput.style.left = this.sketchpad.width / 0.7 + x - 1 + "px";
             

            // input.typeInput.style.top = this.sketchpad.height / 0.7 + y - this.getSize() / 2 + "px";
             

            fontLoad.style.left = this.sketchpad.width / 2.7 + x - 1 + "px";
            fontLoad.style.top =  this.sketchpad.height / 2.3 + y - this.getSize() / 2 + "px";
            fontLoad.style.display = 'block'
        } else {
